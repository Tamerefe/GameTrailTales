...
<body class="page" data-spy="scroll" data-target=".navbar" onload="startTime()">
    ...
    <div class="container mt-5 pt-5 sign">
      <div class="wrap d-md-flex">
        <img class="w-50" src="Photo/scgc.jpg" alt="">
        <div class="p-4 p-md-5">
          <div class="d-flex">
            <div class="w-100">
              <h3 class="mb-4" style="text-align: end;">Reset Your Password</h3>
            </div>
          </div>
          <form action="#" class="signin-form">
            ...
            <div class="form-group">
              <button type="submit" class="form-control btn btn-warning rounded submit px-3">Give me a Code</button>
            </div>
          </form>
