...
<head>
  ...
  <header class="page">
    <div class="col-md-11 mx-auto mt-5 pt-4">
        <img class="w-100 rounded" src="dl.jpg">
        <div class="carousel-caption">
          <h2 class="text-left">Dying Light Detailed Examination Or Analysis</h2>
        </div>
    </div>
  </header>
          ...
          <div class="card mt-3">
              <div class="card-body font-weight-bold">
                  ...
                  <p>
                    ...
                    <i class="fas fa-times text-danger"></i> Casual Players. <br>
                    <i class="fas fa-check text-success"></i> competitive players. <br>
                  </p>
                  <h3>Graphics:</h3>
                  <p>
                    ...
                    <i class="fas fa-times text-danger"></i> Beautiful. <br>
                    <i class="fas fa-check text-success"></i> Masterpiece. <br>
                  ...
                  <p>
                    ...
                    <i class="fas fa-times text-danger"></i> Fast. <br>
                  ...
                  <p>
                    ...
                    <i class="fas fa-check text-success"></i> Medium. ( 10 - 20 hours) <br>
                    <i class="fas fa-times text-danger"></i> Long. ( 20 - 40 hours) <br>
                    <i class="fas fa-times text-danger"></i> Very Long. ( 40 - 80 hours) <br>
                  ...
                  <p>
                    ...
                    <i class="fas fa-times text-danger"></i> Average. <br>
                    <i class="fas fa-check text-success"></i> Good. <br>
                  ...
                  <p>
                    ...
                    <i class="fas fa-check text-success"></i> Nothing. <br>
                  </p>
                  <h3>Final:</h3>
                  <p>
                    <i class="fas fa-times text-danger"></i> Terrible. <br>
                    <i class="fas fa-times text-danger"></i> Meh. <br>
                    <i class="fas fa-times text-danger"></i> Ok. <br>
                    <i class="fas fa-check text-success"></i> Average. <br>
                    <i class="fas fa-times text-danger"></i> Good. <br>
                  ...
                  <p>It's a Masterpiece That Can Be Played a Lot Of times</p>
                  <h3>Others:</h3>
                  <p>
                  ...
                  <h3>Final Score:</h3>
                  <br>
                    <h4 class="text-warning">90/100 <i class="fas fa-trophy"></i></h4>
                  <br>
                  <div class="d-inline cardfooter text-muted">By Brother Of Site Designer</div>
                  <br>
