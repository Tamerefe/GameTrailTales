...
<head>
  ...
  <header class="page">
    <div class="col-md-11 mx-auto mt-5 pt-4">
        <img class="w-100 rounded" src="ut.png">
        <div class="carousel-caption">
          <h2 class="text-left">Undertale Detailed Examination Or Analysis</h2>
        </div>
    </div>
  </header>
          ...
          <div class="card mt-3">
              <div class="card-body font-weight-bold">
                  ...
                  <p>
                    ...
                    <i class="fas fa-times text-danger"></i> Potato <br>
                    <i class="fas fa-check text-success"></i> Minimum. <br>
                  ...
                  <p>
                    ...
                    <i class="fas fa-check text-success"></i> Short. ( 4 - 10 hours) <br>
                  ...
                  <p>This game has a great story that make you want play more 3 endings that you want to pick the most enjoyable one happy/bad ending or normal one pick the most enjoyable one</p>
                  <h3>Others:</h3>
                  <p>
                  ...
                  <h3>Final Score:</h3>
                  <br>
                    <h4 class="text-warning">100/100 <i class="fas fa-trophy"></i></h4>
                  <br>
